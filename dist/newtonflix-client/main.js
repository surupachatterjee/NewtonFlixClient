...
var MovieComponent = /** @class */ (function () {
    function MovieComponent(movieService) {
        ...
        this.searchMovie = 'newton';
        this.showAlert = false;
    }
    MovieComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.movieService.getMovies('newton').subscribe(function (moviesFound) {
            _this.moviesFound = moviesFound;
            _this.movies = moviesFound;
        });
    };
    MovieComponent.prototype.search = function () {
        var _this = this;
        console.log(this.searchMovie);
        if (this.searchMovie !== '' && this.searchMovie !== 'newton') {
            this.movieService.getMovies(this.searchMovie)
                .subscribe(function (moviesFound) {
                console.log(moviesFound);
                _this.movies = moviesFound;
            }, function (err) {
                // alert(err.error);
                _this.showAlert = true;
                _this.errMessage = err.error;
            });
        }
    ...
    MovieComponent.prototype.dismissAlert = function () {
        this.showAlert = false;
        this.searchMovie = '';
        this.movies = this.moviesFound;
    };
...
var MovieService = /** @class */ (function () {
    ...
    MovieService.prototype.getMovies = function (query) {
        var url = this.baseURL + "/movie/" + query;
